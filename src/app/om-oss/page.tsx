    ...
    <>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Belief
            n="01"
            title="Helheten är värd mer än summan"
            body="Sol som inte snackar med batteri som inte snackar med värmepump kostar dig pengar varje timme. Vi syr ihop systemet, inte bara komponenterna."
          />
          <Belief
            n="02"
