...
export const metadata = {
  title: "Kalkylator — räkna på din helhet",
  description:
    "Designa hela energilösningen i en levande 3D-modell. Byt växelriktare, batteri, värmepump och paneler — siffrorna räknas om i realtid.",
};
    ...
    <>
      <section className="container-edge pt-12 md:pt-20 pb-10">
        <div className="max-w-3xl">
          <div className="eyebrow">Kalkylator · digital tvilling</div>
