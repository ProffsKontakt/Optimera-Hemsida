...
/**
 * DEMO-variant av Process. Skillnader mot live (på kundfeedback):
 *  - Steg 02: "lyssnar på elskåpet" borttaget (otydligt).
 *  - Steg 03: "1:1-modell av huset" ersatt – vi gör aldrig en 1:1-modell.
 *    Nu: "Vi räknar på förutsättningarna" och hittar det mest optimala.
 * Live:s Process är orörd.
 */
const steps = [
  {
    n: "01",
  ...
  },
  {
    ...
    body: "Vi kommer hem, tittar på taket, går igenom elskåpet och pratar om vad du faktiskt vill ha. Bullar ingår.",
  },
  {
    n: "03",
