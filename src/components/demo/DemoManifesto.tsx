...
/**
 * DEMO-variant av Manifesto. Enda skillnaden mot live: värmepump-omnämnandet
 * i första punkten är borttaget (värmepump finns inte med på demo-landningen).
 * Live:s Manifesto är orörd.
 */
const items = [
  {
    ...
    body:
      "Vi finns inte för att sälja paket. Bra rådgivning är inte alltid bekväm rådgivning. När vi tycker att du borde vänta, dimensionera mindre, eller lägga pengarna på batteri istället för fler paneler, då säger vi det. Det är därför vi finns.",
  },
  {
